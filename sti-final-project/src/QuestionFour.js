  ...
  render() {
    ...
    return (
      <div style={{ backgroundColor: "#3EC6FF" }}>
        ...
        <h1 style={{ color: "white" }}>Temperatura fría</h1>
        <div className="recuadro-medio">
        <h3 style={{ color: "#004A69" }}>En una escala del 1 al 10, ¿cuán importante es para ti que un espacio de estudio tenga una <strong>temperatura fría</strong>?</h3>
          ...
          <div className="question">Pregunta 4 de 8</div>
