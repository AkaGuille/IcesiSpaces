  ...
  render() {
    ...
    return (
      <div style={{ backgroundColor: "#3EC6FF" }}>
        ...
        <h1 style={{ color: "white" }}>Aglomeración</h1>
        <div className="recuadro-medio">
        <h3 style={{ color: "#004A69" }}>En una escala del 1 al 10, ¿Cuál es tu preferencia en cuanto a la <strong>cantidad de personas</strong> en un espacio de estudio?</h3>
          ...
          <div className="question">Pregunta 1 de 8</div>
