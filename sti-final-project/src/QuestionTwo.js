  ...
  render() {
    ...
    return (
      <div style={{ backgroundColor: "#3EC6FF" }}>
        ...
        <h1 style={{ color: "white" }}>Ruido</h1>
        <div className="recuadro-medio">
        <h3 style={{ color: "#004A69" }}>En una escala del 1 al 10, ¿Cuál es tu preferencia en cuanto al <strong>nivel de ruido </strong> en un espacio de estudio?</h3>
          ...
          <div className="question">Pregunta 2 de 8</div>
