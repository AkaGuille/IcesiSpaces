  ...
  render() {
    ...
    return (
      <div style={{ backgroundColor: "#3EC6FF" }}>
        ...
        <h1 style={{ color: "white" }}>Comodidad</h1>
        <div className="recuadro-medio">
        <h3 style={{ color: "#004A69" }}>En una escala del 1 al 10, ¿Qué tan importante es para ti la <strong>comodidad de los muebles</strong> en un espacio de estudio?</h3>
          ...
          <div className="question">Pregunta 6 de 8</div>
